...
# DCVL-3D research group, https://github.com/DCVL-3D/ILGS_release
# This work is licensed under the same terms as the original Inria project.
# Please see the LICENSE file for details.
#
# ------------------------------------------------------------------------
# Modified from original codes in an Inria project
#
...
class GaussianModel:
    ...
    def removal_setup(self, training_args, mask3d):
        ...
        self._semantic_feature = nn.Parameter(set_requires_grad(semantic_feature_sub, False))
    ...
    def save_ply(self, path):
        ...
        attributes = np.concatenate((xyz, normals, f_dc, f_rest, opacities, scale, rotation, obj_dc, semantic_feature), axis=1)
    ...
    def densification_postfix(self, new_xyz, new_features_dc, new_features_rest, new_opacities, new_scaling, new_rotation, new_objects_dc, new_semantic_feature):
        d = {"xyz": new_xyz,
    ...
    def densify_and_split(self, grads, grad_threshold, scene_extent, N=2):
        ...
        self.densification_postfix(new_xyz, new_features_dc, new_features_rest, new_opacity, new_scaling, new_rotation, new_objects_dc,new_semantic_feature)
    ...
    def densify_and_clone(self, grads, grad_threshold, scene_extent):
        ...
        self.densification_postfix(new_xyz, new_features_dc, new_features_rest, new_opacities, new_scaling, new_rotation, new_objects_dc,new_semantic_feature)
